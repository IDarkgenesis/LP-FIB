...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\3\2\3\4\4\2\4\2\4\3\2\5\6\3\2\7\b\2\33\2\6\3\2\2\2")
        buf.write("\4\t\3\2\2\2\6\7\5\4\3\2\7\b\7\2\2\3\b\3\3\2\2\2\t\n\b")
        buf.write("\3\1\2\n\13\7\3\2\2\13\27\3\2\2\2\f\r\f\6\2\2\r\16\7\4")
...
class ExprParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "NUM", "POW", "DIV", "MUL", "MENYS", 
                      "MES", "WS" ]
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        if not(_la==ExprParser.DIV or _la==ExprParser.MUL):
                        ...
                        self.state = 17
                        _la = self._input.LA(1)
                        if not(_la==ExprParser.MENYS or _la==ExprParser.MES):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
